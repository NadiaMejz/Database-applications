...
namespace APBD25Test2.Migrations
{
    ...
    [Migration("20250610130550_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD25Test2.Models.Race", b =>
                {
            ...
            modelBuilder.Entity("APBD25Test2.Models.RaceParticipation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            TrackRaceId = 2,
                            RacerId = 4,
                            FinishTimeInSeconds = 800,
                            Position = 1
                        });
                });

            modelBuilder.Entity("APBD25Test2.Models.Racer", b =>
                {
                    b.Property<int>("RacerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD25Test2.Models.Track", b =>
                {
            ...
            modelBuilder.Entity("APBD25Test2.Models.TrackRace", b =>
                {
                    b.Property<int>("TrackRaceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD25Test2.Models.RaceParticipation", b =>
                {
                    b.HasOne("APBD25Test2.Models.Racer", "Racer")
                        .WithMany("RaceParticipations")
                        .HasForeignKey("RacerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD25Test2.Models.TrackRace", "TrackRace")
                        .WithMany("RaceParticipations")
            ...
            modelBuilder.Entity("APBD25Test2.Models.TrackRace", b =>
                {
                    b.HasOne("APBD25Test2.Models.Race", "Race")
                        .WithMany("TrackRaces")
                        .HasForeignKey("RaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD25Test2.Models.Track", "Track")
                        .WithMany("TrackRaces")
